    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <asp:Button ID="btnAdd" runat="server" class="btn yellow" Text="Add" ValidationGroup="Save" OnClick="btnAdd_Click" />
                    <asp:Button ID="btnSearch" runat="server" class="btn yellow" Text="Search" OnClick="btnSearch_Click" />
                </div>
            </div>
        </div>
    </div>
